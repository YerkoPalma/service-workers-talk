  ...
  return html`
    <body class="overflow-hidden cf center bg-washed-red code pa4">
      ...
      raw(state.slides.content
        .replace(/<pre/g, '<pre class=\"near-white bg-mid-gray overflow-x-scroll pa3\"')
        .replace(/<p><img /g, '<p class="f4 f2-ns lh-copy georgia mv0 w-50 dib ml4 fl"><img ')
        .replace(/<img /g, '<img class=\"mw-100\"')
        ...
        .replace(/<h(\d)>/g, '<h$1 class=\"f$1 mt0 georgia\">')
        .replace(/<ul>/g, '<ul class=\"dib fl\">')
